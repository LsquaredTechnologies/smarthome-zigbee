...
{
    public sealed record ReadAttributesResponsePayload(NWK.Address NwkAddr, ushort ClusterID, APP.Endpoint SrcEndpoint, APP.Endpoint DstEndpoint, Array<AttributeResponsePayload> Attributes) : ICommandPayload
    {
